...
let handler = async (m, { conn, reply }) => {
  ...
  if (!/image\/(jpe?g|png|webp)/i.test(mime)) {
    return reply("reply / kirim gambar dengan caption .tomonyet")
  }
  ...
  let api = `https://api-faa.my.id/faa/tomonyet?url=${encodeURIComponent(imageUrl)}`
