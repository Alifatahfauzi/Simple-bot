...
const cacheBustImport = async (absPath) => {
  ...
  const url = `${absPath}?v=${global.plugins}_${mtime}`;
  return import(url);
};
...
// Terimakasih telah menggunakan base script bot whatsapp, script ini akan di kembangkan pada saat ada yang error saja
