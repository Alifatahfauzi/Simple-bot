...
> 7. Lakukan pencadangan database secara berkala untuk mengurangi risiko kehilangan data
> 8. Setiap error, kendala, atau masalah yang terjadi akibat penggunaan script menjadi tanggung jawab pengguna
> 9. Pengguna bertanggung jawab atas proses instalasi, konfigurasi, pemeliharaan, serta penyesuaian script sesuai dengan kebutuhannya

> [!CAUTION]
> **Ketentuan Modifikasi dan Penjualan**
>
> Script ini diperbolehkan untuk dimodifikasi dan diperjualbelikan sesuai dengan kebutuhan pengguna
>
> Setelah script dimodifikasi, dikembangkan, atau dijual kembali, segala permasalahan yang timbul dari hasil modifikasi atau penggunaan ulang bukan menjadi tanggung jawab owner script
>
> Mohon untuk tidak menghubungi owner script terkait error, kerusakan, atau kendala yang disebabkan oleh modifikasi maupun perubahan yang dilakukan oleh pengguna atau pihak lain
>
> Untuk mendapatkan script versi terbaru, pembaruan script, atau update resmi dari owner, pengguna dapat menghubungi owner melalui kontak yang tersedia pada bagian **Support & Credits**
